                ...
                <div class="row">
                    ...
                    <div class="careerfy-column-9 careerfy-typo-wrap">
                        ...
                        <div id="app">
                          ...
                          <main>
                            <div class="con-img">
                              <img src="{{ url('/') }}/images/conversation.png">
                              <h2>Select a Conversation</h2>
                              <p>Try selecting a conversation or searching for someone specific.</p>
                            </div>
                          </main>
                          @else 
                            <h1>No user are avaliable for contact.Please select from contact.</h1>
                          @endif
                          <footer>
                            {!! Form::open(['method'=>'POST','action'=>'MessageController@store','files'=>true]) !!}
                              ...
                              <div id="input-container">
                                  <textarea placeholder="Your message here" name="message" disabled="disabled"></textarea>
