        ...
        <div class="container">
            <div class="row">
                ...
                <div class="careerfy-column-9 careerfy-typo-wrap">
                    @if(count($job_state) > 0)
                    <!-- FilterAble -->
                    <div class="careerfy-filterable">
                        @if(count($job_state) >= 10)
                            <h2>Showing 1-10 of {{count($job_state)}} results</h2>
                        @else
                            <h2>Showing {{count($job_state)}} results</h2>
                        @endif
