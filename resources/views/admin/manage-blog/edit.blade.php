                ...
                <div class="content">
                    ...
                    <div class="block block-rounded block-bordered">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            {!! Form::model($blog,['method'=>'PATCH','action'=>['Admin\AdminCreateBlog@update',$blog->id],'files'=>true]) !!}
                            @csrf
                                <div class="careerfy-employer-box-section">
                                    <div class="row careerfy-employer-profile-form">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <img src="{{url('/')}}/blog-images/{{$blog->photo}}" alt="" style="display: block;margin-bottom: 10px;border: 1px solid #ddd;max-width: 100%;max-height: 45vh;">
                                        ...
                                        <div class="col-md-12">
                                          <div class="form-group">
                                              <div class="custom-control custom-checkbox">
                                                  <input type="checkbox" class="custom-control-input" id="example-checkbox-custom1" name="status" value="1" @if($blog->status == 1) checked="checked" @endif>
...
<script type="text/javascript">
    $('#example-checkbox-custom1').on('change', function(){
